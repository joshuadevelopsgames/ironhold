...
public record TreeDecorator(net.minecraft.world.level.levelgen.feature.treedecorators.TreeDecorator decorator,
                             net.minecraft.world.level.levelgen.feature.treedecorators.TreeDecorator modifiedDecorator)
        implements TemplateDecorator<TreeContext> {

    public static final MapCodec<TreeDecorator> CODEC = RecordCodecBuilder.<TreeDecorator>mapCodec(instance -> instance.group(
    ...
    public void apply(LevelAccessor level, TreeContext buffer, RandomSource random, boolean modified) {
        ...
        net.minecraft.world.level.levelgen.feature.treedecorators.TreeDecorator.Context ctx =
                new net.minecraft.world.level.levelgen.feature.treedecorators.TreeDecorator.Context(
                        worldGenLevel,
                        (pos, state) -> worldGenLevel.setBlock(pos, state, 19),
                        random,
                        logs,
                        leaves,
                        ImmutableSet.of()
