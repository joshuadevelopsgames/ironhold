...
import kingdom.smp.entity.MiraInnkeeperEntity;
...
/**
 * Renderer for Mira the Innkeeper — vanilla villager rig with BUTCHER overlay
 * (apron silhouette reads naturally as an innkeeper / barkeep).
 */
public class MiraInnkeeperRenderer
    extends AgeableMobRenderer<MiraInnkeeperEntity, VillagerRenderState, VillagerModel> {
    ...
    public MiraInnkeeperRenderer(EntityRendererProvider.Context ctx) {
        super(ctx,
    ...
    @Override
    public void extractRenderState(MiraInnkeeperEntity entity, VillagerRenderState state, float partialTick) {
        ...
        state.villagerData = new VillagerData(
            ...
            profRegistry.getOrThrow(VillagerProfession.BUTCHER),
            1);
    }
}
