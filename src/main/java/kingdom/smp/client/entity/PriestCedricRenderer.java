...
import kingdom.smp.entity.PriestCedricEntity;
...
/**
 * Renderer for Brother Cedric the Priest — vanilla villager rig with the
 * CLERIC profession overlay (white robe + cleric headpiece read as a
 * traditional priest).
 */
public class PriestCedricRenderer
    extends AgeableMobRenderer<PriestCedricEntity, VillagerRenderState, VillagerModel> {
    ...
    public PriestCedricRenderer(EntityRendererProvider.Context ctx) {
        super(ctx,
    ...
    @Override
    public void extractRenderState(PriestCedricEntity entity, VillagerRenderState state, float partialTick) {
