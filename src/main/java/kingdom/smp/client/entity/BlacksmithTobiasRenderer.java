...
import kingdom.smp.entity.BlacksmithTobiasEntity;
...
/**
 * Renderer for Master Tobias the Blacksmith — vanilla villager rig with the
 * WEAPONSMITH profession overlay (the apron + smith goggles read as a
 * working blacksmith).
 */
public class BlacksmithTobiasRenderer
    extends AgeableMobRenderer<BlacksmithTobiasEntity, VillagerRenderState, VillagerModel> {
    ...
    public BlacksmithTobiasRenderer(EntityRendererProvider.Context ctx) {
        super(ctx,
    ...
    @Override
    public void extractRenderState(BlacksmithTobiasEntity entity, VillagerRenderState state, float partialTick) {
        ...
        state.villagerData = new VillagerData(
            ...
            profRegistry.getOrThrow(VillagerProfession.WEAPONSMITH),
            1);
    }
}
