...
/**
 * Same pipeline as {@link net.minecraft.client.renderer.entity.IllusionerRenderer}
 * (illusion offsets, spell item pose, hat), with a dark-mage texture (illager UVs).
 */
public class ArcaneInvokerRenderer extends IllagerRenderer<ArcaneInvokerEntity, IllusionerRenderState> {

    private static final Identifier TEXTURE =
        Identifier.fromNamespaceAndPath(Ironhold.MODID, "textures/entity/evil_evoker.png");

    public ArcaneInvokerRenderer(EntityRendererProvider.Context ctx) {
    ...
    @Override
    public void extractRenderState(ArcaneInvokerEntity entity, IllusionerRenderState state, float partialTick) {
    ...
    @Override
    protected AABB getBoundingBoxForCulling(ArcaneInvokerEntity entity) {
